...
[DimEmailID] [int] NULL,
[CreatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Creat__64ED6EB2] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__Source_Di__Updat__65E192EB] DEFAULT (getdate()),
