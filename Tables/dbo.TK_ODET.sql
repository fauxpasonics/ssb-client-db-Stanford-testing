...
GO
CREATE NONCLUSTERED INDEX [IX_ODET_COVERING] ON [dbo].[TK_ODET] ([SEASON], [CUSTOMER], [ETLSID]) INCLUDE ([E_SBLS_1], [EXPORT_DATETIME], [I_BPTYPE], [I_DAMT], [I_DATE], [I_DISP], [I_FPRICE], [I_MARK], [I_OQTY], [I_PAY], [I_PL], [I_PRICE], [I_PT], [INREFDATA], [INREFSOURCE], [ITEM], [ORIG_SALECODE], [PROMO], [ZID])
GO
