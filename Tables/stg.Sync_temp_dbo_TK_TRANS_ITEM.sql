CREATE TABLE [stg].[Sync_temp_dbo_TK_TRANS_ITEM]
(
...
GO
ALTER TABLE [stg].[Sync_temp_dbo_TK_TRANS_ITEM] ADD CONSTRAINT [PK__Sync_tem__19364FD26962A690] PRIMARY KEY CLUSTERED  ([ETL_Sync_Id])
GO
