...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Creat__14923298] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceMerg__Updat__158656D1] DEFAULT (getdate()),
