...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____2389BFA9] DEFAULT (getdate()),
[ETL__UpdatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____247DE3E2] DEFAULT (getdate()),
