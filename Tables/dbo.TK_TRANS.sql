...
GO
CREATE NONCLUSTERED INDEX [ix_tk_trans_season_transno] ON [dbo].[TK_TRANS] ([SEASON], [TRANS_NO]) INCLUDE ([DATE])
GO
CREATE NONCLUSTERED INDEX [IDX_TK_TRANS_SOURCE_Include] ON [dbo].[TK_TRANS] ([SOURCE]) INCLUDE ([DATE], [E_STAT], [SEASON], [TRANS_NO]) WITH (DATA_COMPRESSION = PAGE)
GO
