...
*/
		...
		SELECT 
			...
			/*AddressPrimary*/
			, CASE WHEN PrimaryAddressType = 'M' THEN LEFT(PrimaryAddressStreet,500)
			...
			, CASE WHEN PrimaryAddressType = 'M' THEN LEFT(PrimaryAddressCity,200)
				ELSE COALESCE(Address2City, Address3City, Address4City, Address5City) END AS [AddressPrimaryCity] 
			, CASE WHEN primaryaddresstype = 'M' THEN LEFT(PrimaryAddressState,200)
				ELSE COALESCE(Address2state, Address3State, Address4State, Address5State) END AS [AddressPrimaryState] 
			, CASE WHEN PrimaryAddressType = 'M' THEN LEFT(PrimaryAddressZipCode,25)
			...
			, CASE WHEN PrimaryAddressType = 'M' THEN LEFT(PrimaryAddressCountry,200)
			...
			, CAST(OtherPhone AS NVARCHAR(25)) PhonePrimary
